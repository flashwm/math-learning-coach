...
- `plugin-source\math-learning-coach`：Codex 个人插件源码，是后续优先维护和发布的正式形态。
...
- `scripts\publish-plugin.ps1`：把本项目插件源码同步到 Codex 个人插件目录。
...
1. 先按新规则立刻修正当前题。
2. 同步修改个人插件目录 `C:\Users\xiao\plugins\math-learning-coach`。
